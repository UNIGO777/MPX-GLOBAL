...
6.12 Endpoints: GET /public/search, GET /public/facets, POST /search/ai, GET /public/products/:id, GET /exporters/:id (shipped M1 route), POST|DELETE|GET /saved.
