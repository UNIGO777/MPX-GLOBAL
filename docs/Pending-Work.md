...
- **Testing** — backend suite is green (95 files / 1391 tests, 2026-09-25). Web: ✅ **test setup added 2026-09-25** (`npm test` in `web/`, vitest 3 + jsdom + Testing Library): 42 tests covering the shared logic and key screens. Most pages are still untested, and the app has no test runner.
