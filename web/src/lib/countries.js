...
//
// The Caribbean members of the North American plan carry their AREA CODE here
// (Bahamas 1242, Jamaica 1876…): each island has exactly one, so it is part of
// the country's real dialling prefix, and the list no longer shows a dozen
// identical "+1" rows (owner, 2026-09-23). US, Canada and the Dominican
// Republic (809/829/849) genuinely share plain +1 with many area codes, and
// Russia/Kazakhstan genuinely share +7 — those stay shared, told apart by name.
// The longest value, "+1242", fits the backend's 5-char `countryCode`, and
// `normalizeMobile` builds the same E.164 either way.
const DIAL = {
  ...
  DK: '45', DM: '1767', DO: '1', DZ: '213', EC: '593', EE: '372', EG: '20', ER: '291',
  ES: '34', ET: '251', FI: '358', FJ: '679', FR: '33', GA: '241', GB: '44', GD: '1473',
  GE: '995', GH: '233', GM: '220', GN: '224', GQ: '240', GR: '30', GT: '502', GW: '245',
  GY: '592', HK: '852', HN: '504', HR: '385', HT: '509', HU: '36', ID: '62', IE: '353',
  IL: '972', IN: '91', IQ: '964', IR: '98', IS: '354', IT: '39', JM: '1876', JO: '962',
  JP: '81', KE: '254', KG: '996', KH: '855', KM: '269', KN: '1869', KP: '850', KR: '82',
  KW: '965', KZ: '7', LA: '856', LB: '961', LC: '1758', LI: '423', LK: '94', LR: '231',
  ...
  TT: '1868', TW: '886', TZ: '255', UA: '380', UG: '256', US: '1', UY: '598', UZ: '998',
  VC: '1784', VE: '58', VN: '84', VU: '678', WS: '685', YE: '967', ZA: '27', ZM: '260',
  ZW: '263',
};
...
/** "+1242" → "+1 242": the area-coded NANP prefixes read as country + area. */
function displayDial(dial) {
  return /^\+1\d{3}$/.test(dial) ? `+1 ${dial.slice(2)}` : dial;
}

/** Dial-code options for the mobile input, labelled. `value` is the compact code. */
export const DIAL_OPTIONS = COUNTRIES.map(({ code, name, dial }) => ({
  value: dial,
  label: `${displayDial(dial)} (${code})`,
  name,
}));
