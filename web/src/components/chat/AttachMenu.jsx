...
import { DocIcon, ImageIcon, PlusIcon } from '../ui/icons.jsx';
 ...
 */
export function AttachMenu({ onPickImage, onPickDocument, disabled = false }) {
  ...
  if (!onPickImage && !onPickDocument) return null;
