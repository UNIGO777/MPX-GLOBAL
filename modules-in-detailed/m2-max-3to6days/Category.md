...
> - 🔁 **2026-09-23 — seller-written "Additional specifications" now EXIST** (`Product.customSpecs`, client change request, owner-approved). The "no free-form specs anywhere" line below is superseded for that one mechanism; "Other" itself still has fixed fields. Display-only, capped, contact-free, never searchable — build-prompt §A17.
