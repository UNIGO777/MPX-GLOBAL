...
```js
{
  ...
  sellerCountry,   // 🔴 §A23 denormalised org.country (internal-only, NEVER public) — country facet ke liye (§A26: pipeline single-collection rahe)
